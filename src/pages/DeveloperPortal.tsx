...
export const DeveloperPortal: React.FC = () => {
  ...
  const sandboxAvailable = useMemo(() => typeof (window as any).sandboxRunner !== 'undefined', []);

  const subNavTabs = useMemo(() => {
    const tabs: { id: PortalTab; label: string; icon: typeof Activity }[] = [
    ...
    if (sandboxAvailable) {
      tabs.push({ id: 'sandbox', label: 'Sandbox', icon: FlaskConical });
    }
    return tabs;
  }, [sandboxAvailable]);
