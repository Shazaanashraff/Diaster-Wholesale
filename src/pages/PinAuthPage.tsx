...
export const PinAuthPage: React.FC<PinAuthPageProps> = ({ onSuccess }) => {
  ...
  const submitPin = useCallback((entered: string) => {
    if (entered === CORRECT_PIN) {
      ...
      setSuccess(true);
      // Let the tick animation play, then fade out and enter
    ...
    >
        ...
        >
          ...
          <div style={{ position: 'relative', width: 160, height: 160 }}>
            <div style={{
              ...
              animation: 'ring-pulse 1.2s ease-out 0.3s infinite',
            }} />
            <div style={{
              position: 'absolute', inset: 12, borderRadius: '50%',
              background: 'rgba(16,185,129,0.08)',
              animation: 'ring-pulse 1.2s ease-out 0.5s infinite',
            }} />
            ...
            >
              ...
              <circle
                ...
                style={{ animation: 'circle-draw 0.55s cubic-bezier(0.4,0,0.2,1) 0.15s forwards' }}
              />
              {/* Checkmark */}
              <polyline
                points="48,82 68,102 112,56"
                fill="none"
                stroke="#10b981"
                strokeWidth="6"
                strokeLinecap="round"
                ...
                strokeDasharray="90"
                strokeDashoffset="90"
                style={{ animation: 'check-draw 0.4s cubic-bezier(0.4,0,0.2,1) 0.65s forwards' }}
              />
            </svg>
          </div>
          ...
          <div style={{ marginTop: 28, textAlign: 'center', animation: 'text-rise 0.5s ease 0.9s both' }}>
            <p style={{ color: '#34d399', fontSize: 22, fontWeight: 700, fontFamily: 'Urbanist, sans-serif', letterSpacing: '0.02em' }}>
              Access Granted
            </p>
      ...
      >
        ...
        <div className="text-center">
          <div className="text-3xl font-bold text-white tracking-wide" style={{ fontFamily: 'Urbanist, sans-serif' }}>
            Diastar
          </div>
        ...
        <div
          ...
          style={{ animation: shake ? 'pin-shake 0.5s ease' : undefined }}
        >
        ...
        <div style={{ height: 20, textAlign: 'center' }}>
          {error && (
            <p className="text-sm" style={{ color: locked ? '#f87171' : '#fca5a5' }}>
              {error}
            </p>
          )}
        </div>
