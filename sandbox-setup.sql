-- ================================================================
-- DIASTAR ERP — Sandbox Schema Setup
-- Run this ONCE in Supabase Dashboard → SQL Editor → New query
--
-- SAFE: Does NOT touch the 'public' (production) schema.
-- Creates a fully isolated 'sandbox' schema with the same tables,
-- views, functions and seed data as production.
--
-- After running this script, go to:
--   Supabase Dashboard → Settings → API → Exposed Schemas
--   Add 'sandbox' to the list, then Save.
-- ================================================================
...
-- DONE. Now go to:
-- Supabase Dashboard → Settings → API → Exposed Schemas
-- Add 'sandbox' to the list and click Save.
-- ================================================================
